  ...
  return (
    <div className="mb-16 flex overflow-hidden rounded-md border border-gray-200 bg-white">
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <ConfirmationDialogContent
          variety="danger"
          title={t("lb_delete_service_type")}
          confirmBtnText={t("lb_confirm_delete_service_type")}
          loadingText={t("lb_confirm_delete_service_type")}
          onConfirm={(e) => {
            e.preventDefault();
            deleteEventTypeHandler(deleteDialogTypeId);
          }}>
          {t("lb_delete_service_type_description")}
        </ConfirmationDialogContent>
      </Dialog>
    </div>
  );
...
const CreateFirstEventTypeView = () => {
  ...
  return (
    <EmptyScreen
      Icon={FiLink}
      headline={t("lb_new_service_type_heading")}
      description={t("lb_new_service_type_description")}
    />
  );
};
